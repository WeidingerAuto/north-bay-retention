        ...
        {view==="entry" && (
          <div>
            ...
            {currentEntries.filter(e=>!e.id?.startsWith("hist-")).length > 0 && (
              <div className="no-print" style={{background:"white",borderRadius:10,border:"1px solid #38bdf8",overflow:"hidden",marginBottom:20}}>
          ...
          <div>
            ...
            <div style={{background:"white",borderRadius:10,border:"1px solid #38bdf8",padding:32,boxShadow:"0 1px 4px rgba(0,0,0,0.06)"}}>
              ...
              {!isCurrentMonthAggregate && currentEntries.filter(e=>!e.id?.startsWith("hist-")).length > 0 ? (
                ...
                <div style={{background:"#f8fafc",border:"1px solid #38bdf8",borderRadius:8,padding:16,marginBottom:24,fontSize:13,color:"#64748b",textAlign:"center"}}>
